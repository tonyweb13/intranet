...
<script>
    ...
    import GenerateReportButton from "../buttons/genereateReportButton";

    export default {
        name: 'generateSummary',
        data: function () {
            return {
                title: 'Generate Monthly Detailed Report',
                header: 'Generate Monthly Detailed Report',
                locations: [],
                supervisors: [],
        ...
        components: {
            ...
            IboxTitleHeader, Months, SearchButtonIcon}
    }
</script>